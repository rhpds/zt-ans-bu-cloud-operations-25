...
c. Click **Next**, **Next**, then **Finish**.
--

. **Add the second node (Job Template).**
+
Hover over the `AWS Source` node you just created, click the **elipsis** icon, and select *Add Step and link*. Configure it as follows:
+
--
